      ...
      {item.type === "link" ? (
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            ...
            } lg:hidden transition-all duration-500 pt-4 lg:absolute lg:bottom-0 lg:right-0 lg:transfrom lg:translate-y-full lg:group-hover:block w-max`}
          >
  ...
  return (
    <section className="sticky top-0 left-0 right-0 z-50">
      <header className="container mx-auto px-4 flex justify-between py-4 items-center">
        <div>
          <img className="w-16" src={images.Logo} alt="blog logo" />
        </div>
